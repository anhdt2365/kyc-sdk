...
import { KycProgramType, KycProgramIDL } from "./types";
...
export class Context {
    ...
    readonly program: Program<KycProgramType>;
    ...
    public static from(
        ...
        const program = new Program(KycProgramIDL, programId, anchorProvider);
    ...
    public static withProvider(
        ...
        const program = new Program(KycProgramIDL, programId, provider);
        return new Context(provider, provider.wallet, program, fetcher, opts);
    }
    ...
    public constructor(
        ...
        this.program = program as unknown as Program<KycProgramType>;
