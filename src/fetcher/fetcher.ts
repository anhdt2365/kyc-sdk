 ...
 * Supported accounts
 */
type CachedValue = ParsableProviderConfig | ParsableUserConfig | ParsableUserKyc;
...
export class AccountFetcher {
    ...
    // YOUR CODE:
    public async getProviderConfig(address: Address, refresh = false): Promise<ProviderConfigData | null> {
        return this.get(translateAddress(address), ParsableProviderConfig, refresh);
    }

    public async getUserConfig(address: Address, refresh = false): Promise<UserConfigData | null> {
        return this.get(translateAddress(address), ParsableUserConfig, refresh);
    }

    public async getOneUserKyc(address: Address, refresh = false): Promise<UserKycData | null> {
        return this.get(translateAddress(address), ParsableUserKyc, refresh);
    }
}
