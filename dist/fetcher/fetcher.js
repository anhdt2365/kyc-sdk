...
class AccountFetcher {
    ...
    // YOUR CODE:
    getProviderConfig(address, refresh = false) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.get((0, anchor_1.translateAddress)(address), parsing_1.ParsableProviderConfig, refresh);
        });
    }
    getUserConfig(address, refresh = false) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.get((0, anchor_1.translateAddress)(address), parsing_1.ParsableUserConfig, refresh);
        });
    }
    getOneUserKyc(address, refresh = false) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.get((0, anchor_1.translateAddress)(address), parsing_1.ParsableUserKyc, refresh);
        });
    }
}
